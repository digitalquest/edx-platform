...
class CourseAccessHandler(object):
    ...
    def _get_courses_with_access_type(self, user, access_type):
        """
        Returns all courses for global staff.  Otherwise, returns list of courses
        ...
        if not course_ids:
            ...
            if GlobalStaff().has_user(user):
                # Use mongo for global staff because not all courses have roles and would thus
                # be excluded from the list of courses returned
